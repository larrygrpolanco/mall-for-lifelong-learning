      ...
      <div className="max-w-4xl mx-auto">
        <SectionReveal>
          ...
          <p className="font-serif italic text-navy-light text-lg mb-14 max-w-xl">
            Three interconnected constructs — UX, metacognition, and motivation — explored through
            Garrison's Self-Directed Learning framework.
          </p>
        </SectionReveal>
        ...
        >
          {researchQuestions.map((rq) => (
            ...
            >
              {/* Left accent bar */}
              <motion.div
                className="w-1 bg-gold-bright shrink-0 transition-all duration-300 group-hover:w-1.5"
              />
