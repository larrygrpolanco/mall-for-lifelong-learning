export const meta = {
  ...
  subtitle: "Older Adults' Self-Directed Language Learning via Duolingo",
  researcher: 'Jihye Kim, Ph.D.',
  institution: 'University of South Florida',
  department: 'Department of World Languages',
  year: '2026',
  advisor: 'Dr. Matt Kessler',
}
...
export const quotes = [
  {
    text: "I'm old, I'm slow — I'll take what I can get. Actually pretty proud of myself to get this far.",
    attribution: '— P8, Age 65',
  },
  {
    text: 'As a person grows old, brain function is going to die. I started because of this.',
    attribution: '— Sung-jin, Age 68',
  },
  {
    text: "Is it pride? I think it's a kind of energy I get... now I know how to look up things you don't know.",
    attribution: '— Jung-ja, Age 78',
  },
  {
    text: "I mean, none of this really matters in the real sense, but still my brain tells me, hey, you're in the Diamond League.",
    attribution: '— Ken, Age 64',
  },
  {
    text: 'Arabic — for fun. Klingon — I\'m a Star Trek nerd.',
    attribution: '— P9',
  },
]
